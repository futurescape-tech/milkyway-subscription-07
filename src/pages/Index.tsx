      ...
      <main className="container mx-auto py-12 px-4">
        ...
        <section className="py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="transition-all hover:shadow-lg border-2 border-purple-400 shadow-md">
              <CardHeader>
                <CardTitle>Family</CardTitle>
                <CardDescription>Great for families</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-3xl font-bold mb-4">$49<span className="text-base font-normal text-gray-500">/month</span></p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <Card className="transition-all hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-3xl font-bold mb-4">$79<span className="text-base font-normal text-gray-500">/month</span></p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-12">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Why Choose MilkSub?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
